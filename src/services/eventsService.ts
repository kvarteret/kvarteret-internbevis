...
import { pickHomeEvents } from "./eventsSelection"
import { db } from "./firebase"

const HOME_EVENTS_QUERY_LIMIT = 30

function mapEventDocument(id: string, data: Record<string, unknown>): FirestoreEventDocument {
    return {
        id,
...
export async function fetchHomeEvents(_signal?: AbortSignal): Promise<FirestoreEventDocument[]> {
...
export { pickHomeEvents, selectEventTranslation } from "./eventsSelection"
