...
export const HomeScreen = ({
  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      ...
      <ScrollView
        className="flex-1"
        contentContainerClassName="px-2 pb-20 pt-1.5"
      >
              ...
              <View className="flex-1 gap-1.5">
                ...
                <View className="h-1.5 w-full overflow-hidden rounded-full bg-surface-muted">
                  <View
                    ...
                    style={{ width: state.nowPlayingProgressWidth }}
                  />
                </View>
              </View>
            </StateSurface>
      ...
      <View className="w-full items-center justify-center bg-background pb-4 pt-2">
