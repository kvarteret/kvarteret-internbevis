    ...
    <SafeAreaView className="flex-1 bg-background">
      ...
      <View className="w-full items-center justify-center pb-4 pt-2">
        <View className="w-full flex-row flex-nowrap items-center justify-center px-1">
          ...
          <Text className="px-1.5 font-inter text-2xl leading-8 text-text-primary" numberOfLines={1}>
            |
          </Text>
          <TouchableOpacity accessibilityRole="link" className="shrink" onPress={handleOpenVolunteerPage}>
            <Text
              adjustsFontSizeToFit
