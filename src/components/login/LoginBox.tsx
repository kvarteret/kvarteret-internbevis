    ...
    return (
        ...
        >
            <View className="w-[92%] max-w-xl rounded-card border border-white/35 bg-black/55 p-6 shadow-card">
                <Text className="text-center font-inter-bold text-3xl leading-9 text-surface">
                    {t("login")}
                </Text>
                ...
                <View className="mt-6 gap-6">
                    ...
                    <View className="flex-row items-start">
                        ...
                        >
                            ...
                            >
                                {privacyPolicyChecked ? (
                                    <Text className="font-inter-bold text-sm leading-3 text-surface">
                                        ✓
                                    </Text>
                                ) : null}
                            </View>
                        ...
                        <Pressable className="ml-3 flex-1" onPress={onPrivacyPress}>
                            <Text className="font-inter text-xs text-link underline">
